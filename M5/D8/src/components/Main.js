  ...
  return (
    <>
      <Container>
        ...
        {
          loading &&
            !error && ( //se sta caricando e non ci sono errori
              <PacmanLoader color="#36d7b7" className="mt-3 mb-5" />
            ) /*se sta caricando parte lo spinner*/
        }
        {!loading &&
          !error && ( //se loading è false e non ci sono errori mostrami tutto
            <div>
              <SearchBar books={books} setRenderBooks={setRenderBooks} />
